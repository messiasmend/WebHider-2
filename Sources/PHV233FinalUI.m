...
static void P233Render(id self, SEL _cmd, BOOL hierarchyMode) {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [NSLayoutConstraint activateConstraints:@[
            [panel.centerXAnchor constraintEqualToAnchor:vc.view.centerXAnchor],[panel.centerYAnchor constraintEqualToAnchor:vc.view.centerYAnchor],[panel.widthAnchor constraintEqualToConstant:350],[panel.heightAnchor constraintEqualToConstant:650],
            ...
            [seg.leadingAnchor constraintEqualToAnchor:panel.leadingAnchor constant:14],[seg.trailingAnchor constraintEqualToAnchor:panel.trailingAnchor constant:-14],[seg.topAnchor constraintEqualToAnchor:info.bottomAnchor constant:12],[seg.heightAnchor constraintEqualToConstant:54],
            ...
            [copyC.leadingAnchor constraintEqualToAnchor:panel.leadingAnchor constant:14],[copyC.trailingAnchor constraintEqualToAnchor:panel.trailingAnchor constant:-14],[copyC.topAnchor constraintEqualToAnchor:seg.bottomAnchor constant:10],[copyC.heightAnchor constraintEqualToConstant:52],[copy.leadingAnchor constraintEqualToAnchor:copyC.leadingAnchor],[copy.trailingAnchor constraintEqualToAnchor:copyC.trailingAnchor],[copy.topAnchor constraintEqualToAnchor:copyC.topAnchor],[copy.bottomAnchor constraintEqualToAnchor:copyC.bottomAnchor],
            [hiddenC.leadingAnchor constraintEqualToAnchor:panel.leadingAnchor constant:14],[hiddenC.trailingAnchor constraintEqualToAnchor:panel.trailingAnchor constant:-14],[hiddenC.topAnchor constraintEqualToAnchor:copyC.bottomAnchor constant:10],[hiddenC.heightAnchor constraintEqualToConstant:52],[hidden.leadingAnchor constraintEqualToAnchor:hiddenC.leadingAnchor],[hidden.trailingAnchor constraintEqualToAnchor:hiddenC.trailingAnchor],[hidden.topAnchor constraintEqualToAnchor:hiddenC.topAnchor],[hidden.bottomAnchor constraintEqualToAnchor:hiddenC.bottomAnchor],
            [hideC.leadingAnchor constraintEqualToAnchor:panel.leadingAnchor constant:14],[hideC.trailingAnchor constraintEqualToAnchor:panel.trailingAnchor constant:-14],[hideC.topAnchor constraintEqualToAnchor:hiddenC.bottomAnchor constant:10],[hideC.heightAnchor constraintEqualToConstant:52],[hide.leadingAnchor constraintEqualToAnchor:hideC.leadingAnchor],[hide.trailingAnchor constraintEqualToAnchor:hideC.trailingAnchor],[hide.topAnchor constraintEqualToAnchor:hideC.topAnchor],[hide.bottomAnchor constraintEqualToAnchor:hideC.bottomAnchor],
            [close.leadingAnchor constraintEqualToAnchor:panel.leadingAnchor constant:14],[close.bottomAnchor constraintEqualToAnchor:panel.bottomAnchor constant:-14],[close.heightAnchor constraintEqualToConstant:52],[close.trailingAnchor constraintEqualToAnchor:panel.centerXAnchor constant:-5],
            [save.leadingAnchor constraintEqualToAnchor:panel.centerXAnchor constant:5],[save.trailingAnchor constraintEqualToAnchor:panel.trailingAnchor constant:-14],[save.bottomAnchor constraintEqualToAnchor:panel.bottomAnchor constant:-14],[save.heightAnchor constraintEqualToConstant:52]
        ]];
    });
}
