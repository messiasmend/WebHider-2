...
static void P233Render(id self, SEL _cmd, BOOL hierarchyMode) {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        UIButton *left=P233Button(vc,back?@"Voltar":@"Elemento",back?@"chevron.left":@"list.bullet.indent",back?@selector(backTapped):@selector(hierarchyTapped),P233C(@"#0A84FF"),P233C(@"#191D24"),YES);[seg addSubview:left];
        UIButton *json=P233Button(vc,@"JSON",@"curlybraces",NSSelectorFromString(@"ph_jsonTapped26"),P233C(@"#C7CBD1"),P233C(@"#15171B"),YES);[seg addSubview:json];
        ...
        [NSLayoutConstraint activateConstraints:@[[panel.centerXAnchor constraintEqualToAnchor:vc.view.centerXAnchor],[panel.centerYAnchor constraintEqualToAnchor:vc.view.centerYAnchor],[panel.widthAnchor constraintEqualToConstant:350],[panel.heightAnchor constraintEqualToConstant:588],[h.topAnchor constraintEqualToAnchor:panel.topAnchor constant:15],[h.centerXAnchor constraintEqualToAnchor:panel.centerXAnchor],[h.widthAnchor constraintEqualToConstant:60],[h.heightAnchor constraintEqualToConstant:6],[t.topAnchor constraintEqualToAnchor:h.bottomAnchor constant:18],[t.leadingAnchor constraintEqualToAnchor:panel.leadingAnchor constant:15],[t.trailingAnchor constraintEqualToAnchor:panel.trailingAnchor constant:-15],[s.topAnchor constraintEqualToAnchor:t.bottomAnchor constant:4],[s.leadingAnchor constraintEqualToAnchor:panel.leadingAnchor constant:15],[s.trailingAnchor constraintEqualToAnchor:panel.trailingAnchor constant:-15],[info.leadingAnchor constraintEqualToAnchor:panel.leadingAnchor constant:14],[info.trailingAnchor constraintEqualToAnchor:panel.trailingAnchor constant:-14],[info.topAnchor constraintEqualToAnchor:s.bottomAnchor constant:16],[info.heightAnchor constraintEqualToConstant:180],[seg.leadingAnchor constraintEqualToAnchor:panel.leadingAnchor constant:14],[seg.trailingAnchor constraintEqualToAnchor:panel.trailingAnchor constant:-14],[seg.topAnchor constraintEqualToAnchor:info.bottomAnchor constant:12],[seg.heightAnchor constraintEqualToConstant:43],[left.leadingAnchor constraintEqualToAnchor:seg.leadingAnchor constant:5],[left.topAnchor constraintEqualToAnchor:seg.topAnchor constant:5],[left.bottomAnchor constraintEqualToAnchor:seg.bottomAnchor constant:-5],[left.widthAnchor constraintEqualToAnchor:seg.widthAnchor multiplier:.5 constant:-7.5],[json.trailingAnchor constraintEqualToAnchor:seg.trailingAnchor constant:-5],[json.topAnchor constraintEqualToAnchor:seg.topAnchor constant:5],[json.bottomAnchor constraintEqualToAnchor:seg.bottomAnchor constant:-5],[json.widthAnchor constraintEqualToAnchor:left.widthAnchor],[copyC.leadingAnchor constraintEqualToAnchor:panel.leadingAnchor constant:14],[copyC.trailingAnchor constraintEqualToAnchor:panel.trailingAnchor constant:-14],[copyC.topAnchor constraintEqualToAnchor:seg.bottomAnchor constant:10],[copyC.heightAnchor constraintEqualToConstant:42],[copy.leadingAnchor constraintEqualToAnchor:copyC.leadingAnchor],[copy.trailingAnchor constraintEqualToAnchor:copyC.trailingAnchor],[copy.topAnchor constraintEqualToAnchor:copyC.topAnchor],[copy.bottomAnchor constraintEqualToAnchor:copyC.bottomAnchor],[hiddenC.leadingAnchor constraintEqualToAnchor:panel.leadingAnchor constant:14],[hiddenC.trailingAnchor constraintEqualToAnchor:panel.trailingAnchor constant:-14],[hiddenC.topAnchor constraintEqualToAnchor:copyC.bottomAnchor constant:10],[hiddenC.heightAnchor constraintEqualToConstant:42],[hidden.leadingAnchor constraintEqualToAnchor:hiddenC.leadingAnchor],[hidden.trailingAnchor constraintEqualToAnchor:hiddenC.trailingAnchor],[hidden.topAnchor constraintEqualToAnchor:hiddenC.topAnchor],[hidden.bottomAnchor constraintEqualToAnchor:hiddenC.bottomAnchor],[hideC.leadingAnchor constraintEqualToAnchor:panel.leadingAnchor constant:14],[hideC.trailingAnchor constraintEqualToAnchor:panel.trailingAnchor constant:-14],[hideC.topAnchor constraintEqualToAnchor:hiddenC.bottomAnchor constant:10],[hideC.heightAnchor constraintEqualToConstant:42],[hide.leadingAnchor constraintEqualToAnchor:hideC.leadingAnchor],[hide.trailingAnchor constraintEqualToAnchor:hideC.trailingAnchor],[hide.topAnchor constraintEqualToAnchor:hideC.topAnchor],[hide.bottomAnchor constraintEqualToAnchor:hideC.bottomAnchor],[close.leadingAnchor constraintEqualToAnchor:panel.leadingAnchor constant:14],[close.bottomAnchor constraintEqualToAnchor:panel.bottomAnchor constant:-14],[close.heightAnchor constraintEqualToConstant:42],[close.trailingAnchor constraintEqualToAnchor:panel.centerXAnchor constant:-5],[save.leadingAnchor constraintEqualToAnchor:panel.centerXAnchor constant:5],[save.trailingAnchor constraintEqualToAnchor:panel.trailingAnchor constant:-14],[save.bottomAnchor constraintEqualToAnchor:panel.bottomAnchor constant:-14],[save.heightAnchor constraintEqualToConstant:42]]];
    });
}
